...
#### These mapping functions originate from SalishSeaTools (https://salishsea-meopar-tools.readthedocs.io/en/latest/SalishSeaTools/index.html) and were slightly adapted for my personal application/usage
